...
from app.models import base_model, attachment, event, notification, user
    ...
    def __init__(self):
        ...
        '''self.__engine = create_engine(
            'mysql+mysqldb://{}:{}@{}/{}'.format(
                ...
                os.environ.get('EBUZZ_MYSQL_PWD'),
                os.environ.get('EBUZZ_MYSQL_HOST'),
                os.environ.get('EBUZZ_MYSQL_DB')))
        if os.environ.get("EBUZZ_ENV") == 'test':
